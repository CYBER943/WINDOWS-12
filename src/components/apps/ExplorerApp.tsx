          ...
          <div>
            ...
            <div className="pl-6 space-y-1 mt-1">
              <button className="w-full flex items-center gap-2 px-2 py-1.5 text-sm rounded hover:bg-black/5 dark:hover:bg-white/10 text-left">
                <Icon name="Folder" size={20} className="text-blue-500 fill-blue-500/20" /> Desktop
              </button>
              <button className="w-full flex items-center gap-2 px-2 py-1.5 text-sm rounded hover:bg-black/5 dark:hover:bg-white/10 text-left">
                <Icon name="Download" size={20} className="text-blue-500 fill-blue-500/20" /> Downloads
              </button>
              <button className="w-full flex items-center gap-2 px-2 py-1.5 text-sm rounded hover:bg-black/5 dark:hover:bg-white/10 text-left">
                <Icon name="Documents" size={20} className="text-blue-500 fill-blue-500/20" /> Documents
              </button>
              <button className="w-full flex items-center gap-2 px-2 py-1.5 text-sm rounded hover:bg-black/5 dark:hover:bg-white/10 text-left">
                <Icon name="Pictures" size={20} className="text-blue-500 fill-blue-500/20" /> Pictures
              </button>
            </div>
          </div>
        ...
        <div className="flex-1 p-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            {['Users', 'Windows', 'Program Files', 'Concept Data'].map((name) => (
              <button key={name} className="flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-white/5 transition-colors group text-center">
                <Icon name="Folder" size={48} className="text-yellow-400 fill-yellow-400/20 group-hover:scale-105 transition-transform" />
          ...
          <div className="grid grid-cols-4 gap-4">
            <button className="flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-white/5 transition-colors group text-center">
              <Icon name="File" size={48} className="text-blue-500 group-hover:scale-105 transition-transform" />
              <span className="text-sm truncate w-full">readme.txt</span>
            </button>
            <button className="flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-white/5 transition-colors group text-center">
              <Icon name="Pictures" size={48} className="text-green-500 group-hover:scale-105 transition-transform" />
